...
test("resolveBrowserExecutablePath skips Remote Vibes browser detour wrappers", async () => {
  const tempDir = await mkdtemp(path.join(os.tmpdir(), "remote-vibes-browser-runtime-"));
