  ...
  },
  {
    ...
    agentGuide: {
      ...
      useCases: [
        ...
        "Answer direct picture or image requests by publishing a local image or safe remote image URL to the agent canvas.",
        "Use Vibe Research endpoints and helper commands as the source of truth for visible agent state instead of scraping the UI or asking the human to report what the app can prove.",
      ...
      commands: [
        ...
        { label: "Set image URL canvas", command: "vr-agent-canvas --url https://example.com/image.png --title \"Reference image\"", detail: "Shows a hosted image in the selected agent's terminal chat canvas." },
      ...
      setup: [
        ...
        "Prefer guide-listed Vibe Research endpoints and helper commands before manual UI inspection, filesystem poking, or asking the human to confirm state.",
        ...
        "When the human asks to see a picture, use the canvas for the visual answer when a suitable image can be created, fetched, screenshotted, or linked.",
